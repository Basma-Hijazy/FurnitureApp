...
import 'package:zoonMall/data_model/order_create_response.dart';
import 'package:zoonMall/data_model/payment_type_response.dart';
import 'package:zoonMall/data_model/paypal_url_response.dart';
...
class PaymentRepository {
  Future<List<PaymentTypeResponse>> getPaymentResponseList() async {
    final response = await http.get(
      "${AppConfig.BASE_URL}/payment-types",
    );
