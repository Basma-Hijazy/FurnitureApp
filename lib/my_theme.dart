...
class MyTheme {
  ...
  static Color accent_color = Color.fromRGBO(195, 46, 128, 1);
  static Color soft_accent_color = Color.fromRGBO(70, 189, 170, 1);
  static Color splash_screen_color = Color.fromRGBO(6, 29, 37, 1);
  ...
  static Color light_grey = Color.fromRGBO(137, 235, 219, 0.8);
