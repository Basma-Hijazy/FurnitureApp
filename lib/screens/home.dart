...
import 'package:zoonMall/custom/toast_component.dart';
import 'package:zoonMall/helpers/shimmer_helper.dart';
import 'package:zoonMall/my_theme.dart';
import 'package:zoonMall/repositories/category_repository.dart';
import 'package:zoonMall/repositories/product_repository.dart';
import 'package:zoonMall/repositories/sliders_repository.dart';
import 'package:zoonMall/screens/category_list.dart';
import 'package:zoonMall/screens/filter.dart';
import 'package:zoonMall/screens/flash_deal_list.dart';
import 'package:zoonMall/screens/todays_deal_products.dart';
import 'package:zoonMall/screens/top_selling_products.dart';
import 'package:zoonMall/ui_elements/product_card.dart';
import 'package:zoonMall/ui_sections/main_drawer.dart';
...
class _HomeState extends State<Home> {
            ...
            SliverList(
              delegate: SliverChildListDelegate([
                Padding(
                  ...
                  child: buildHomeCarouselSliderrrr(context),
                ),
                Padding(
                  padding: const EdgeInsets.fromLTRB(
                    8.0,
    ...
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            //snapshot.hasError
            //print("product error");
            print('error getFeturedProducts ${snapshot.error.toString()}');
            return Container();
  ...
  buildHomeCarouselSliderrrr(context) {
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            ...
            // for(int i= sliderResponse.sliders ;i>0 ; i-- )
            //   {
            //     carouselImageList.add(sliderResponse.sliders[i].photo);
            //   }
            sliderResponse.sliders.forEach((slider) {
              carouselImageList.add(slider.photo);
            });
            int i = carouselImageList.length-1;
            for(; i>-1 ;i-- )
              {
                carouselImageList2.add(carouselImageList[i]);
              }
                    ...
                    return Stack(
                      children: <Widget>[
                        ...
                        Align(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: carouselImageList2.map((url) {
                              int index = carouselImageList2.indexOf(url);
                              return Container(
                                width: 7.0,
                                height: 7.0,
