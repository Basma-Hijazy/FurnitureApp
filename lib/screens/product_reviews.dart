...
import 'package:zoonMall/dummy_data/reviews.dart';
    ...
    return ExpandableNotifier(
      ...
      child: Column(
        ...
        children: <Widget>[
          Expandable(
            collapsed: Container(
                height: reviewList[index].text.length > 100 ? 32 : 16,
          ...
          reviewList[index].text.length > 100
              ? Row(
                ...
                onTap: () {
                  ...
                  if (_my_rating < 1.0) {
                    ToastComponent.showDialog(
                        "Atleast one star must be given", context,
                        gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
                  }
                },
                child: Container(
